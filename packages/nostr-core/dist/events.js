 ...
 */
export function createEvent(template, privateKey) {
 ...
 */
export function createContactsEvent(contacts, privateKey) {
 ...
 */
export function createReactionEvent(targetEventId, targetAuthor, reaction, privateKey) {
    return createEvent({
        kind: 7,
        content: reaction,
        tags: [
 ...
 */
export function createDeleteEvent(eventIdsToDelete, reason, privateKey) {
 ...
 */
export function createRepostEvent(originalEventId, originalAuthor, relayUrl, privateKey) {
    return createEvent({
        kind: 6,
        content: '',
        tags: [
 ...
 */
export function extractMentions(event) {
    return event.tags
 ...
 */
export function addHashtagsToEvent(template, hashtags) {
 ...
 */
export function mentionsPubkey(event, pubkey) {
 ...
 */
export function isRecentEvent(event, maxAgeSeconds = 3600) {
